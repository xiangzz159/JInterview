...
### 同步机制(https://blog.csdn.net/weixin_34186128/article/details/93447488)
...
|类型|机制|应用场合|
|:--|:--|:--|
|spinlock|使用忙等方法，进程不挂起|(1)用于多处理器间共享数据 <br> (2)在可抢占的内核线程里共享数据 <br> (3)自旋锁适合于保持时间非常短的情况，它可以在任何上下文使用，比如终中断上下文|
